...
public class Args {
     ...
     * encapsulating each command-line option in one of these ArgDesc objects,
    ...
    private static ArgDesc[] options = {
            ...
            new ArgDesc("-scan", "Scan Scheme code, output tokens as XML", Modes.SCAN),
            ...
            new ArgDesc("-full", "Scan, parse, and interpret Scheme code", Modes.FULL),
    };
